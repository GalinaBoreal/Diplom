...
class User(AbstractUser):
    ...
    """
    REQUIRED_FIELDS = []  # список имен полей, которые будут запрашиваться при создании пользователя, createsuperuser
    objects = UserManager()
    USERNAME_FIELD = 'email'  # строка с именем поля модели, которая используется в качестве уникального идентификатора
    ...
    # логический атрибут, указывает, считается ли пользователь «активным»
    ...
    class Meta:
        ...
        ordering = ('email',)  # по возрастанию, "-" по убыванию, "?" случайно, можно несколько
...
class ProductInfo(models.Model):
    ...
    class Meta:
        ...
        ]  # ограничение гарантирует, что продукт в магазине имеет уникальный внешний ид
...
class ProductParameter(models.Model):
    ...
    class Meta:
        ...
        ]  # ограничение гарантирует, что продукт имеет описание (информацию).
...
class ConfirmEmailToken(models.Model):
    ...
    # Key field, though it is not the primary key of the mode
